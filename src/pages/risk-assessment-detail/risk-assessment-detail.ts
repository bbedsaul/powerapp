...
@Component({
  selector: 'page-risk-assessment-detail',
  templateUrl: 'risk-assessment-detail.html'
})
export class RiskAssessmentDetailPage {
  ...
  ionViewWillEnter() {
    ...
    console.log('ionViewWillEnter RiskAssessmentDetailPage');
  }
